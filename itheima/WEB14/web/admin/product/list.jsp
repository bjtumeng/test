...
<body>
	<br>
	<form id="Form1" name="Form1" action="${pageContext.request.contextPath}/adminSearchProduct" method="post">
						...
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr onmouseover="this.style.backgroundColor = 'white'"
								...
								<td align="center" style="HEIGHT: 22px">
									<%--可以连续写--%>
									<a href="${ pageContext.request.contextPath }/adminShowProduct?pid=${product.pid}">
