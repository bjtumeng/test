	...
	<div style="width: 380px; margin: 0 auto; margin-top: 50px;">
		<ul class="pagination" style="text-align: center; margin-top: 10px;">
			...
			<%--<li class="active"><a href="#">1</a></li>--%>
				<c:forEach begin="1" end="${PageBean.totalPage}" var="currentPage">
					<c:if test="${PageBean.currentPage==currentPage}">
						<li class="active"><a href="javascript:void(0);">${currentPage}</a></li>
					</c:if>
					<c:if test="${PageBean.currentPage!=currentPage}">
						<li ><a href="${pageContext.request.contextPath}/productList?currentPage=${currentPage}">${currentPage}</a></li>
					</c:if>
				</c:forEach>
